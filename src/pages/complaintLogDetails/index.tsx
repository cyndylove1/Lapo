...
export default function ComplaintLogDetails() {
  return (
    <>
      <div>
            ...
            <div className="grid grid-cols-2">
              ...
              <div>
                <div className="my-2">
                  ...
                  <h2 className="border-[1px] flex items-center justify-center my-2 border-[#ABEFC6] bg-[#ECFDF3] h-[30px] w-[100px] rounded-[16px] text-[#067647] satoshi-500 text-[16px] leading-[18px]">
                    Resolved
                  </h2>
                </div>
                <div className="my-4">
