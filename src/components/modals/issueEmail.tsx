...
export default function IssueEmailModal({ isIssueEmail, onClose }: EmailModalProps) {
  if (!isIssueEmail) return null;

  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 px-4">
      <div className="relative z-10 w-full max-w-[496px] h-[312px] overflow-y-auto rounded-xl bg-white">
        {/* Overlay */}
        <div
