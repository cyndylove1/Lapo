...
export default function IssueSmsModal({ isIssueSms, onClose }: SmsModalProps) {
  if (!isIssueSms) return null;

  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 px-4">
      <div className="relative z-10 w-full md:w-[496px] h-[312px] overflow-y-auto rounded-xl bg-white">
        {/* Overlay */}
        <div
        ...
        {/* Modal Content */}
        <div className="relative z-10 w-[496px] h-[312px] rounded-xl bg-white shadow-md">
          ...
          <form action="">
            <div className="border-[1px] border-(--border)">
              <div className="my-[30px] mx-4 ">
                <Label text="Phone Number" hideIcon={true} />
                <Input placeholder="Enter phone number" hideIcon={true} />
              </div>
            </div>
            <Button
