...
export default function GenerateModal({ isGenerateOpen, onClose, onEmailClick, onPinClick, onSmsClick }: ModalProps) {
  if (!isGenerateOpen) return null;

  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/70 px-4">
      <div className="relative z-10 w-full md:w-[496px]  w-full h-[214px] overflow-y-auto rounded-xl bg-white">
        {/* Overlay */}
        <div
