...
function createData(
  ...
  return { name, code, address, zone, date };
}

// Table data
const rows = [
  createData("HeadOffice", 202, "Lekki", "Lagos", "10/18/2024 14:39:58"),
  createData("HeadOffice", 202, "Lekki", "Lagos", "10/18/2024 14:39:58"),
  createData("HeadOffice", 202, "Lekki", "Lagos", "10/18/2024 14:39:58"),
];
      ...
      <Table sx={{ minWidth: 650, borderCollapse: "collapse" }} size="small">
        <TableHead>
          <TableRow sx={{ backgroundColor: "#f9fafb" }}>
            <TableCell
              align="center"
              sx={{ borderRight: "1px solid #e0e0e0", textAlign: "center", fontSize: "12px", }}
            >
              Name
            </TableCell>
            <TableCell
            ...
            <TableCell align="center" sx={{ textAlign: "center", fontSize: "12px", }}>
              Action
            </TableCell>
          </TableRow>
        </TableHead>
