...
function createData(
  ...
  return { name, phone, month, date, batch };
}
...
export default function PersonalizedTable() {
  return (
    <div className="pt-[15px]">
      <div className="border-[1.5px] border-[#EAECF0] rounded-[4px] ">
        <div className="flex items-center flex-col md:flex-row justify-between p-[5px] bg-[#f9fafb] border-b-[1.5px] border-[#EAECF0]">
          ...
          <div className="flex items-center justify-end gap-[10px] flex-col md:flex-row w-full mt-4 md:mt-0">
