...
function createData(
  ...
  return { name, account, batch, date };
}
...
export default function BlockTableSection() {
  return (
    <div className="pt-[15px]">
      <div className="border-[1.5px] border-[#EAECF0] rounded-[4px] ">
        <div className="flex items-center flex-col md:flex-row justify-between p-[5px] bg-[#f9fafb] border-b-[1.5px] border-[#EAECF0]">
          ...
          <div className="flex items-center gap-[10px] justify-end flex-col mt-4 md:mt-0 md:flex-row w-full">
