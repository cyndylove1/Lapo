...
function createData(
  ...
  return {  account, name, date,resolution, category  };
}
...
export default function ComplaintResolvedTable() {
    const [isFilter, setIsFilter]= useState(false);
  return (
    <div className="pt-[15px]">
      <div className="border-[1.5px] border-[#EAECF0] rounded-[4px] ">
        <div className="flex items-center justify-between md:flex-row flex-col p-[5px] bg-[#f9fafb] border-b-[1.5px] border-[#EAECF0]">
          ...
          <div className="flex items-center gap-[10px] justify-end gap-[10px] flex-col md:flex-row w-full">
            <button className="flex items-center justify-center mt-4 md:mt-0 gap-[16px] h-[36px] lg:w-[82px] w-full rounded-[4px] bg-white border-[1px] border-(--border) ">
              <span>
                <svg
                  width="20"
                  height="21"
            ...
            <button
              className="flex items-center gap-[16px] justify-center h-[36px] lg:w-[82px] w-full rounded-[4px] bg-white border-[1px] border-(--border)"
            ...
            <TableBody>
              {rows.map((row, index) => (
                <TableRow key={index} sx={{ height: "45px" }}>
                  ...
                  >
                    <Link to="/complaint-resolve/details">
      ...
      <FilterModal isFilterOpen={isFilter} onClose={() => setIsFilter(false)} />
    </div>
  );
}
